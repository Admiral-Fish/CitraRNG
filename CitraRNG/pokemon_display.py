...
class PokemonDisplay(QWidget, Ui_PokemonDisplay):
    ...
    def updateInformation(self, pkm):
        ...
        self.labelHP.setText("HP: " + str(pkm.HPCurrent()) + "/" + str(pkm.HP()))
        self.labelAtk.setText("Atk: " + str(pkm.Atk()))
        self.labelDef.setText("Def: " + str(pkm.Def()))
        self.labelSpA.setText("SpA: " + str(pkm.SpA()))
        self.labelSpD.setText("SpD: " + str(pkm.SpD()))
        self.labelSpe.setText("Spe: " + str(pkm.Spe()))
